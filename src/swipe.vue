    ...
    export default {
        ...
        methods: {
            ...
            setActiveClass(index, pageCount) {
                ...
                if (index - 1 > -1) {
                    addClass(this.$children[index - 1].$el, 'before-active')
                } else {
                    addClass(this.$children[pageCount - 1].$el, 'before-active')
                }
                if (index + 1 < pageCount) {
                    addClass(this.$children[index + 1].$el, 'after-active')
                } else {
                    addClass(this.$children[0].$el, 'after-active')
                }
            },
            ...
            doAnimate(towards, options) {
                ...
                setTimeout(() => {
                    ...
                    this.setActiveClass(newIndex, pageCount)
            ...
            doOnTouchStart(event) {
                ...
                var touch = event.type == 'mousedown' ? event : event.touches[0];
            ...
            doOnTouchMove(event) {
                ...
                var dragState = this.dragState;
                var touch = event.type == 'mousemove' ? event : event.touches[0];
        ...
        mounted() {
            ...
            addListenerMulti(element, "touchstart mousedown", (event) => {
                if (this.prevent) {
                    event.preventDefault();
                }
            ...
            addListenerMulti(element, "touchmove mousemove", (event) => {
                if (!this.dragging) return;
                this.doOnTouchMove(event);
            })
            addListenerMulti(element, "touchend mouseup", (event) => {
